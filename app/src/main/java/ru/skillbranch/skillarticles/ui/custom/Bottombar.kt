...
class Bottombar @JvmOverloads constructor(
    ...
    var binding: LayoutBottombarBinding
    ...
    override fun onSaveInstanceState(): Parcelable? {
        ...
        saveState.isSearchMode = isSearchMode
        return saveState
    }
    ...
    private fun animatedHideSearch() {
        ...
        val startRadius = hypot(width.toDouble(), height / 2.toDouble())
    ...
    private class SavedState : BaseSavedState, Parcelable{
        ...
        constructor(parcel: Parcel): super(parcel){
            isSearchMode = parcel.readByte() != 0.toByte()
        }

        override fun writeToParcel(parcel: Parcel, flags: Int) {
            super.writeToParcel(parcel, flags)
            parcel.writeByte(if (isSearchMode) 1 else 0)
        }
        ...
        companion object CREATOR: Parcelable.Creator<SavedState>{
            override fun createFromParcel(source: Parcel) = SavedState(parcel = source)
